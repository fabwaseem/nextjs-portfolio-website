 ...
 * Supports 10 color schemes with light/dark variants.
 */
...
export const vscodeTheme: ThemeDefinition = {
  id: "vscode",
  name: "VS Code",
  description: "Classic VS Code Dark+ and Light+",
  author: "Microsoft",
  light: {
...
export const catppuccinTheme: ThemeDefinition = {
  ...
  light: {
    ...
    syntaxKeyword: "oklch(0.55 0.2 310)",
    syntaxString: "oklch(0.6 0.18 145)",
    syntaxFunction: "oklch(0.55 0.2 240)",
    syntaxVariable: "oklch(0.6 0.18 25)",
    syntaxComment: "oklch(0.58 0.03 260)",
    syntaxNumber: "oklch(0.6 0.18 25)",
    syntaxOperator: "oklch(0.6 0.18 175)",
    ...
    terminalBlue: "oklch(0.55 0.2 240)",
    terminalRed: "oklch(0.6 0.2 25)",
    terminalCyan: "oklch(0.6 0.18 175)",
  ...
  dark: {
    ...
    chart1: "oklch(0.75 0.15 310)",
    chart2: "oklch(0.75 0.13 175)",
    chart3: "oklch(0.75 0.15 350)",
    chart4: "oklch(0.8 0.13 85)",
    chart5: "oklch(0.7 0.18 15)",
    ...
    syntaxKeyword: "oklch(0.75 0.15 310)",
    syntaxString: "oklch(0.75 0.14 145)",
    syntaxFunction: "oklch(0.75 0.15 240)",
    syntaxVariable: "oklch(0.8 0.12 45)",
    syntaxComment: "oklch(0.5 0.02 260)",
    syntaxNumber: "oklch(0.8 0.12 45)",
    syntaxOperator: "oklch(0.75 0.13 175)",
    syntaxType: "oklch(0.8 0.13 85)",
    terminalBg: "oklch(0.15 0.02 270)",
    terminalGreen: "oklch(0.75 0.14 145)",
    terminalYellow: "oklch(0.8 0.13 85)",
    terminalBlue: "oklch(0.75 0.15 240)",
    terminalRed: "oklch(0.7 0.18 15)",
    terminalCyan: "oklch(0.75 0.13 175)",
    terminalMagenta: "oklch(0.75 0.15 310)",
  },
};
